...
ALTER TABLE VENTA_MEDIANTE_DESCUENTO_FIJO ADD CONSTRAINT [FK_VENTA_MEDIANTE_DESCUENTO_FIJO.COD_VENTA] FOREIGN KEY ([COD_VENTA]) REFERENCES [VENTA]([COD_VENTA])
ALTER TABLE VENTA_MEDIANTE_DESCUENTO_FIJO ADD CONSTRAINT [FK_VENTA_MEDIANTE_DESCUENTO_FIJO.CODIGO_DESCUENTO] FOREIGN KEY ([CODIGO_DESCUENTO]) REFERENCES [DESCUENTO_FIJO]([CODIGO_DESCUENTO])
...
ALTER TABLE VENTA_PRODUCTO ADD  CONSTRAINT [FK_VENTA_PRODUCTO.CODIGO_VENTA] FOREIGN KEY ([COD_VENTA]) REFERENCES [VENTA]([COD_VENTA])
...
------
ALTER TABLE VENTA ADD CONSTRAINT [FK_VENTA.ID_MEDIO_ENVIO] FOREIGN KEY ([ID_MEDIO_ENVIO]) REFERENCES [MEDIO_ENVIO_X_CODIGO_POSTAL]([ID_MEDIO_ENVIO])
------
